...
class HydratorsTask extends Shell {
	...
	public function getOptionParser() {
		...
		$parser
			->description(
				__('Generates hydrator classes for document classes.')
			)
			->addOption('filter', array(
				...
				'short' => 'd',
				'default' => null,
				'help' => __('The path to generate your hydrator classes. Default taken from configuration.')
		));
		return $parser;
	}
